const e=(e=null)=>n=>t=>{if(!n)throw"No condition function given";const o=({data:{extension:r,messageType:a,data:l}})=>{"Comic Manager"===r&&a==e&&n(l)&&t(l,o)};window.addEventListener("message",o)},n=(n=null)=>t=>new Promise((o,r)=>{e(n)(t)((e,n)=>{console.log(e),o(e),window.removeEventListener("message",n)})}),t=(e=null)=>(n,{mWindow:t=window,target:o="*"}={})=>{t.postMessage({extension:"Comic Manager",messageType:e,data:n},o)},o=["playback"].reduce((o,r)=>(o[r]={addListener:e(r),sendMessage:t(r),once:n(r)},o),{});var r;!function(e){e.Play="K",e.Ahead5="L",e.Prev5="J",e.Ahead10=";",e.Prev10="H",e.Slower=",",e.Faster=".",e.Seek0="0",e.Seek1="1",e.Seek2="2",e.Seek3="3",e.Seek4="4",e.Seek5="5",e.Seek6="6",e.Seek7="7",e.Seek8="8",e.Seek9="9",e.FullScreen="F"}(r||(r={}));const a=
/*! *****************************************************************************
