...
***************************************************************************** */
function(e,n){var t={};for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&n.indexOf(o)<0&&(t[o]=e[o]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var a=0;for(o=Object.getOwnPropertySymbols(e);a<o.length;a++)n.indexOf(o[a])<0&&Object.prototype.propertyIsEnumerable.call(e,o[a])&&(t[o[a]]=e[o[a]])}return t}(a,["Play","Prev10","Prev5","Ahead10","Ahead5","Slower","Faster","FullScreen"]),s=Object.values(a);Object.values(r);
// ==UserScript==
...
unsafeWindow.playbackControls=Object.assign(unsafeWindow.playbackControls||{},{iframe:e=>{const t=n();t&&o.rawPlayback.sendMessage(e,{mWindow:t.contentWindow})}}),window.addEventListener("keyup",t=>{const a=t.key.toUpperCase();if(!s.includes(a))return;const r=n();if(!r)return;const l={key:t.key,ctrlKey:t.ctrlKey,shiftKey:t.shiftKey,altKey:t.altKey};o.playback.sendMessage({url:e,keyboard:l},{mWindow:r.contentWindow})}),console.log("HTMLVideoController: activated")}();
